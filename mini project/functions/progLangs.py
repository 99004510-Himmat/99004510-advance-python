"""
Function to set the programming languages from the entered PS number from source file
"""
import openpyxl


def programming_languages(row1):
    if 1 <= row1 <= 16:
        object_to_be_loaded = openpyxl.load_workbook("D:\\H\\Work\\Genesis\\99004510-advance python\\mini project\\resource\\raw_data.xlsx")
        sheet_to_be_loaded = object_to_be_loaded['ProgLangs']
